<template>
  <section class="bg-pink relative">
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      >
        <NuxtImg alt=g"Mustang car for login page" src="/images/login-car.webp"
        format="webp" class="absolute inset-0 h-full w-full object-cover" />
        ...
        <div class="max-w-xl lg:max-w-3xl">
          ...
          >
            <form class="space-y-6" @submit.prevent="onLoginFormSubmit">
              <p
                class="text-center text-xl tracking-wider text-white font-[500]"
              >
              ...
              <NuxtLink to="/forgot-password">
                <p
                  class="mt-2 underline hover:text-blue-500 transition-all duration-300"
                >
            ...
            <p class="text-center text-md text-gray-700 tracking-widest">
              ...
              <NuxtLink
                to="/sign-up"
                class="underline hover:text-blue-500 transition-all duration-300"
              >
                Sign Up </NuxtLink
              >.
            </p>
